        ...
        <div class="container d-flex flex-row">
            ...
            <div class="right-section flex-grow-1 p-5 d-flex justify-content-center">
                ...
                <form action="loginAction.php" id="loginForm" method="post">
                    ...
                    <div class="mb-3">
                        <label for="a_useremail" class="form-label">Username or Email Address</label>
                        <input type="text" class="form-control" id="a_useremail" name="a_useremail" required>
                    </div>
                    <div class="mb-3">
                        <label for="a_pass" class="form-label">Password</label>
                        <input type="password" class="form-control" id="a_pass" name="a_pass" required>
                    </div>
                    <button type="submit" class="btn btn-submit login-btn w-100" name="adminLoginForm">Log In</button>

                    <p class="mt-3 text-center">
                        Don’t have an account?
                        <!-- <button type="button" id="showSignupForm" class="btn popup-login-btn w-100">Sign Up</button> -->
                        <a href="adminRegister.php" id="showSignupForm" class="text-primary text-light">Sign Up</a>
                    </p>
                </form>
            </div>
        </div>
